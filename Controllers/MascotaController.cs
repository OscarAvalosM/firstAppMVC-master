...
namespace firstApp.Controllers
{
    ...
    public class MascotaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MascotaID,Nombre,Edad")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MascotaID,Nombre,Edad")] Mascota mascota)
        {
